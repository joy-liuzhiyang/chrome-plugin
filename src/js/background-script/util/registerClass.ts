          ...
          chrome.tabs.sendMessage(
            ...
            (res) => {
              ...
              if (
                ...
                !this.currentRegisterUrl.data ||
                (res.currentCompany &&
                  res.currentCompany.companyId !==
                    this.currentRegisterUrl.data.companyId)
              ) {
                this.currentRegisterUrl = {
                ...
                chrome.storage.sync.set({
                  ihrResumeData: JSON.stringify(this.currentRegisterUrl),
                });
                this.triggerCallBack();
              }
            }
  ...
  triggerCallBack = () => {
    if (this.loginStatusChangeFun) {
      this.loginStatusChangeFun({
        ...
        data:
          this.currentRegisterUrl && this.currentRegisterUrl.data
            ? this.currentRegisterUrl.data
            : null,
